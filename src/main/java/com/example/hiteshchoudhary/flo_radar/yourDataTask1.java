...
class yourDataTask1 {
    ...
    TextView tw;
    private String dt1;
    public yourDataTask1 (Context con,TextView tw,String dt) {
        this.tw = tw;
        this.context=con;
        //this.lv1=tw1;
        dt1=dt;
...
//            String formattedDate=dateFormat. format(date);
          ...
          //  for(int i=0;i<f1.size();i++)
                f3.add("Flow="+f5.get(f5.size()-1)+" L/hour\n" +"Pressure="+f1.get(f1.size()-1)+" MPa\n"+"Temprature="+f2.get(f2.size()-1)+" Celsius\n"+"Humidity="+f6.get(f6.size()-1)+" %\n" );
...
//        };
        ...
        if(dt1.equals("2018-12-05"))
  tw.setText(f3.get(f3.size()-1));
        else
            tw.setText("Select Current Date and try again....");
